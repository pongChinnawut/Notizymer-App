        ...
        <View style={{ flex: 1, backgroundColor: "#be8a59" }}>
          ...
          >
            <View style={{ flexDirection: "row" }}>
              <Text
                style={{ fontSize: 22, color: "#267377", fontWeight: "bold" }}
              >
                ชื่อยา :
              </Text>
              <Text style={{ fontSize: 22, marginBottom: 10,marginLeft:6 }}>
            ...
            <View style={{ flexDirection: "row" }}>
              ...
              <Text style={{ fontSize: 22, marginBottom: 10 ,marginLeft:6}}> {status}</Text>
            </View>
            ...
            <View style={{ flexDirection: "row" }}>
              ...
              <Text style={{ fontSize: 22, marginBottom: 20,marginLeft:6 }}>
