...
class time extends Component {
  ...
  handleClickStartStop() {
    ...
    Alert.alert("ตั้งค่าเวลาเรียบร้อยแล้ว")
  }
...
{/* เช้า */}
        <View style={{backgroundColor:"#a4b3ac",width:null,height:200,margin:20,marginTop:24,borderRadius:30}}>
      ...
      <Picker
            ...
            <View>
            <Text style={{fontSize:20,fontWeight:"bold"}}>{select_morning}</Text>
            </View>
            <TouchableOpacity onPress={this.update_morning}>
            <View style={{width:95,height:35,backgroundColor:"#5f9b9e",borderRadius:10,flexDirection:"row",justifyContent:"center",alignItems:"center",marginRight:10}}>
            <Text style={{fontSize:22,fontWeight:"bold",color:"#1f3526"}}>ยืนยัน</Text>
            </View>
            </TouchableOpacity>
            </View>
            </View>
{/* จบเช้า */}
{/* กลางวัน */}
<View style={{backgroundColor:"#a4b3ac",width:null,height:200,margin:20,marginTop:1,borderRadius:30}}>
    ...
    <Picker
          ...
          >
            ...
            <Picker.Item label="00.00" value="14:27:00" />
          </Picker>
          </View>
          <View>
          <Text style={{fontSize:20,fontWeight:"bold"}}>{select_lanuch}</Text>
          </View>
...
{/* เย็น */}
    ...
    <Picker
          ...
          <View>
          <Text style={{fontSize:20,fontWeight:"bold"}}>{select_dinner}</Text>
          </View>
...
<View style={{backgroundColor:"#a4b3ac",width:null,height:200,margin:20,marginTop:1,borderRadius:30}}>
    ...
    <Picker
          ...
          <View>
          <Text style={{fontSize:20,fontWeight:"bold"}}>{select_goodnight}</Text>
          </View>
